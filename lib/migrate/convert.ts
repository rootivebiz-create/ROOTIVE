...
export function convertPrototype(json: unknown, companyId: string): { backup: BackupJson; warnings: string[] } {
  ...
  driverEntries.forEach(([key, dr], idx) => {
    ...
    drivers.push({
      ...
      line_user_id: "",
      line_linked_at: null,
      weekly_off: [], roster_no: "", birth_date: null, address: "", hired_on: null, appointed_on: null, retired_on: null, license_kinds: "", license_conditions: "",
    });
  });
  ...
  const ensureDriver = (protoId: string, name: string | undefined): string => {
    ...
    drivers.push({ id, company_id: companyId, name: nm, kana: "", is_active: false, royalty_rate: null, mgmt_fee: 0, rounding_mode: null, phone: "", email: "", bank_info: "", memo: "試作データの参照切れから自動作成", sort_order: 999, tax_mode: "taxable", invoice_reg_no: "", payout_month_offset: null, payout_day: null, line_user_id: "", line_linked_at: null, weekly_off: [], roster_no: "", birth_date: null, address: "", hired_on: null, appointed_on: null, retired_on: null, license_kinds: "", license_conditions: "", });
