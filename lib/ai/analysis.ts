...
export const ANALYSIS_SYSTEM_PROMPT = [
  ...
  "- labor に拘束時間の超過や休息の不足があるときは、事故と離職のリスクとして必ず触れる。",
  "  数字を上げるための改善策が、特定のドライバーの稼働をさらに増やすものにならないよう気をつける。",
  "- governance は代表の領域の「件数だけ」です（件名も金額も人の名前も渡していません）。",
  "  overdue_approvals が 1 件以上あれば「決裁が止まっていること自体が損失につながる」と指摘し、",
  "  due_reviews・expiring_insurance・expiring_officers があれば期限として短く触れる。",
  "  件数しか無いので、中身を推測して書かないでください。",
