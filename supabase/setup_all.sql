...
-- 生成元: 0001_schema.sql, 0002_auth_rls.sql, 0003_views.sql, 0004_rpc.sql, 0005_portal_seed.sql, 0006_storage_grants.sql, 0007_driver_rates.sql, 0008_tax_assets_payout.sql, 0009_expenses_invoices.sql, 0010_cashflow_project_pl.sql, 0011_ai_chat_integrations.sql, 0012_operations_compliance.sql
-- =============================================================================
