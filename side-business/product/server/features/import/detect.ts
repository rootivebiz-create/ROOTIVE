...
const KW: [Keyword, RegExp][] = [
  ...
  // 金額の列（数量としては読まない。控除の提案・今の振込額は columns.ts が読む）
  ["money", /単価|金額|円|売上|報酬|支払|請求|税|料金|代金|手当|控除|ロイヤリティ|ロイヤルティ|管理費|事務費|システム料|利用料|使用料|レンタル|駐車|天引|リース|保険|燃料|ガソリン|軽油|立替|立て替え|手数料|振込|支給|差引|委託料|手取/],
