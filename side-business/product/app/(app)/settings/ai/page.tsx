    ...
    <div className="max-w-3xl space-y-5">
      ...
      <Card className="space-y-3 text-sm">
        ...
        <p className="text-xs text-muted-foreground">
          いまの版には、AI にファイルを送る機能はまだ入っていません（どの設定でも、AI には何も送りません）。この同意は、列の自動判定の補助として AI を使う機能を入れたときに、使ってよいかを先に決めておくためのものです。入れたあとも、この同意があり、さらに AI への接続（API キー）を用意しているときだけ動きます。
        </p>
      </Card>
