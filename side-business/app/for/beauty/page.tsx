  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <ul className="mt-4 space-y-1 border-l-4 border-accent pl-3">
        <li>
          美容・ネイル・アイラッシュ・エステ・リラクゼーションの施術の報酬は、源泉徴収の対象に挙げられていません。講習の講師料・デザイン料・モデル料を別に払うときは、その分だけ
      ...
      <div className="prose-ja mt-4">
        ...
        <p>
          ...
          。そのため、業務委託のスタッフに払う施術の報酬からは、源泉徴収をしません（国税庁 タックスアンサー No.2792 の一覧による）。国税庁の質疑応答事例「スタイリスト料及びヘアメイク料」も、写真の撮影などの報酬にはあたらないとして、源泉徴収は要らないとしています。
        </p>
        <p>
          一方、同じ人に払うものでも、講習の講師料・デザイン料・モデル料は源泉徴収が必要です。区分は支払先ごとではなく、
      ...
      <div className="prose-ja">
        ...
        <ul>
          ...
          <li>
            ...
            ：1か月以上の業務委託では、報酬の減額・買いたたき・購入や利用の強制・不当な経済上の利益の提供の要請などが禁止されています。明示していない材料費・タオル代・罰金の差し引きは減額に、店販品や講習を買わせることは購入・利用の強制に、無償の練習会などへの参加の要請は不当な経済上の利益の要請に、あたるおそれがあります。
          </li>
          <li>
            このほか、募集の情報を正確に出すこと（12条）、ハラスメントの相談体制（14条）、6か月以上続く委託を途中で解除する・更新しないときの30日前までの予告（16条）などがあります。
          </li>
          <li>
