...
export const FEATURES = [
  ...
  },
  {
    ...
    body: "今のExcel・CSVを形を変えずに置くだけ。1人1枚の表や○・休の表も読めます。一度読んだ形と、名前の表記ゆれは覚えます。読めるかは、お試しで実物のファイルで先に確かめます",
    short: "形と名前の表記ゆれを覚える。実物のファイルで先に確認",
  },
  {
    title: "ドライバーが納得する明細",
...
export const TRUST = [
  ...
  { title: "AIに渡すものを限る", body: "当方は本番のデータをAIに入れません。製品はいまの版では AI を使っていません（将来使う場合も、御社のオーナーが同意したときだけにします）" },
