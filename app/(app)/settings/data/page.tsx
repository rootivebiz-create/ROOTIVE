      ...
      <div className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {admin ? (
                ...
                <p className="text-xs text-muted-foreground">閲覧者は CSV 出力のみ利用できます（バックアップ JSON は管理者以上）。</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <BackupsList rows={backups} canDownload={admin} />
            </CardContent>
          </Card>
        </div>
