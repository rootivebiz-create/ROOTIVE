...
export default async function MonthsSettingsPage() {
  ...
  return (
    <div>
      ...
      <MonthsTable rows={rows} currentMonth={currentMonth} canClose={editable} canReopen={isOwner(profile.role)} showProfit={access.management} canDownloadBackup={canManage(profile.role)} />
    </div>
  );
}
