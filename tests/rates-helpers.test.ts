...
const masters: Masters = {
  ...
  drivers: [
    ...
    { id: DRIVER3, company_id: COMPANY, name: "停止太郎", kana: "", is_active: false, royalty_rate: null, mgmt_fee: 0, rounding_mode: null, phone: "", email: "", bank_info: "", memo: "", sort_order: 3, tax_mode: "taxable", invoice_reg_no: "", payout_month_offset: null, payout_day: null, line_user_id: "", line_linked_at: null, weekly_off: [], created_at: "", updated_at: "" },
  ],
  projects: [
    {
      id: PROJECT,
