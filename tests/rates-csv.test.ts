...
function driver(id: string, name: string, sort_order: number, is_active = true): Driver {
  return { id, company_id: COMPANY, name, kana: "", is_active, royalty_rate: null, mgmt_fee: 15000, rounding_mode: null, phone: "", email: "", bank_info: "", memo: "", sort_order, created_at: "", updated_at: "" };
}
